...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "gradient-primary text-white shadow-lg shadow-purple-950/30 hover:opacity-90 active:scale-[0.98]",
        destructive:
        ...
        income:
          "gradient-income text-white shadow-md hover:opacity-90 active:scale-[0.98]",
        expense:
          "gradient-expense text-white shadow-md hover:opacity-90 active:scale-[0.98]",
      },
      size: {
